  ...
  return (
    <Card className='h-72 cursor-pointer hover:bg-zinc-900/20 hover:transition-colors'>
      ...
      <CardContent className='text-zinc-400'>
        <p>
          Todas as aplicações estão como repositórios no <a href="" className='font-bold underline text-zinc-600'>Github</a>, e outras até mesmo publicadas,
          as quais poderão ser acessadas nessa página!
        </p>
      </CardContent>
      <CardFooter>
